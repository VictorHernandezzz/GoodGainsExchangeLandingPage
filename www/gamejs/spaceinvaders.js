...
WelcomeState.prototype.enter = function(game) {
    ...
    // Create and load the gamesounds.
    game.sounds = new Sounds();
    game.sounds.init();
    game.sounds.loadSound('shoot', 'gamesounds/shoot.wav');
    game.sounds.loadSound('bang', 'gamesounds/bang.wav');
    game.sounds.loadSound('explosion', 'gamesounds/explosion.wav');
};
...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("GGX Invaders", game.width / 2, game.height/2 - 40);
    ctx.font="18px Arial";
    ctx.fillText("The P2E revolution is happening! Imagine if gamers earned crypto while playing!", game.width / 2, game.height/2);
    ctx.font="16px Arial";
    ctx.fillText("Click on Screen then press Space to Start", game.width / 2, game.height/2 + 40);
};
...
GameOverState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font="16px Arial";
    ctx.fillText("Nice! You earned " + game.score + " GGX tokens, and got to level " + game.level, game.width / 2, game.height/2);
    ctx.font="16px Arial";
    ctx.fillText("Press 'Space' to keep earning more crypto.", game.width / 2, game.height/2 + 40);
};
...
PlayState.prototype.enter = function(game) {
    ...
    image.src = "./gameimg/spaceship.png";
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.drawImage(this.ship.image, this.ship.x - (this.ship.width), this.ship.y - (this.ship.height), this.ship.width * 2, this.ship.height * 2);
    //  Draw invaders.
    ctx.fillStyle = '#000000';
    for(var i=0; i<this.invaders.length; i++) {
        var invader = this.invaders[i];
    ...
    info = "GGX Earned: " + game.score + ", Level: " + game.level;
    ctx.textAlign = "right";
...
function Invader(x, y, rank, file, type) {
    ...
    invaderImage.src = "./gameimg/invader.png";
...
/*
    ...
    The gamesounds class is used to asynchronously load gamesounds and allow
    them to be played.
...
function Sounds() {
    ...
    //  The actual set of loaded gamesounds.
    this.sounds = {};
}
...
Sounds.prototype.loadSound = function(name, url) {
    ...
    //  Create an entry in the gamesounds object.
